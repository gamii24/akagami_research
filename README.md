...
- **本番環境**: https://c32369fc.akagami-research.pages.dev
- **管理画面**: https://c32369fc.akagami-research.pages.dev/admin
- **プロジェクト名**: akagami-research
- **プラットフォーム**: Cloudflare Pages
- **デプロイ状態**: ✅ Active (2026-01-14)
- **最終更新**: 2026-01-14 - 登録者一覧表示修正
...
- **本番URL**: https://c32369fc.akagami-research.pages.dev
- **カテゴリAPI**: https://c32369fc.akagami-research.pages.dev/api/categories
- **PDF一覧API**: https://c32369fc.akagami-research.pages.dev/api/pdfs
- **管理画面**: https://c32369fc.akagami-research.pages.dev/admin
