  ...
  return (
    <html lang="ja">
      ...
      <body class="bg-white dark:bg-darker transition-colors duration-300">
        ...
        <script src="/static/utils.js?v=2026011711" defer></script>
        <script src="/static/app.js?v=2026011711" defer></script>
        <script src="/static/auth.js?v=2026011711" defer></script>
      </body>
    </html>
  )
})
