      ...
      <div class="bg-white rounded-xl shadow-lg p-6 lg:sticky lg:top-8 h-full lg:h-auto overflow-y-auto">
        ...
        <div class="mb-6">
          ...
          <a
            ...
            class="w-full px-4 py-3 bg-blue-50 hover:bg-blue-100 text-blue-700 dark:text-gray-900 rounded-lg transition-colors font-medium border-2 border-blue-200 flex items-center justify-center gap-2 mb-3"
          ...
          <a
            href="/infographics"
            class="w-full px-4 py-3 bg-pink-50 hover:bg-pink-100 text-pink-700 dark:text-gray-900 rounded-lg transition-colors font-medium border-2 border-pink-300 flex items-center justify-center gap-2 mb-3"
    ...
    <div class="min-h-screen bg-white flex flex-col">
      ...
      <main class="flex-1 max-w-7xl w-full mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div class="lg:col-span-3 order-1 lg:order-2">
            <div id="pdf-list" class="grid grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-4">
  ...
  return c.html(
    <html lang="ja">
      ...
      <body class="bg-gray-50 min-h-screen flex flex-col">
        ...
        <script src="/static/utils.js"></script>
        <script src="/static/auth.js"></script>
        <script src="/static/app.js?v=202602051520"></script>
  ...
  return c.html(
    <html lang="ja">
      ...
      <body class="bg-gray-50 flex flex-col min-h-screen">
        ...
        <script defer src="/static/app.js?v=202602051520"></script>
  ...
  return c.html(
    <html lang="ja">
      ...
      <body class="admin-dark bg-darker">
        ...
        <script src="/static/admin.js?v=202601260055" defer></script>
      </body>
    </html>
  )
})
